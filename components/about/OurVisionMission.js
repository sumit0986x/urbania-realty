...
//                             <div className="h-full w-[120%] border-b border-[#96722C] absolute -left-1/3 "></div>
...
//                             />
//                             <h5 className="text-[#96722C]">Our Mission
//                             </h5>
//                             <h3 className="leading-snug">To create spaces that inspire, uplift, and redefine luxury living.</h3>
//                             <p className="text-gray-700 mb-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
//                         </div>
//                     </div>
//                     <div className="w-full md:w-6/12">
